...
<table width="500" border="1" align="center" cellpadding="1" cellspacing="0">
  <tr>
    <td colspan="3" align="center" bgcolor="#99FF33">员工详细信息</td>
  </tr>
  <tr>
    <td width="64">姓名</td>
    <td width="329">${demp.ename}</td>
    <td width="93" rowspan="7" align="left" valign="top"><img name="" src="uppic/${demp.photo}" width="95" height="171" alt="" /></td>
  </tr>
  <tr>
    <td>性别</td>
    <td>${demp.sex}</td>
  ...
  <tr>
    <td colspan="3" align="center" bgcolor="#99FF33">&nbsp;</td>
  </tr>
</table>
